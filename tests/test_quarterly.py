...
def setup_quarter():
 ...
 current='0000000001-25-000002';prior='0000000001-25-000001'
 data=CompanyFacts.model_validate({'cik':1,'entityName':'DEMO Q','facts':{'us-gaap':{
  'Revenues':{'units':{'USD':[row(250,'2025-04-01','2025-06-30',current,'2025-08-01')]}},
...
def test_ytd_difference_and_both_source_accessions():
 data,q=setup_quarter();p=select_period(data,q)
...
def test_different_fiscal_starts_or_future_prior_restatement_are_rejected():
 data,q=setup_quarter();rows=data.facts['us-gaap']['NetCashProvidedByUsedInOperatingActivities'].units['USD']
